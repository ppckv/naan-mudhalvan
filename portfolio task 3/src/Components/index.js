...
function Nav() {
  return (
    <div>
      {" "}
      <nav id="desktop-nav">
        <div class="logo">Prem Kumar N V</div>
        <div>
          <ul class="nav-links">
            <li>
  ...
  return (
    <section id="profile">
      ...
      <div class="section__text">
        ...
        <h1 class="title">Prem Kumar N V</h1>
        ...
        <div id="socials-container">
          <a href="https://www.linkedin.com/in/premkumar-btech/">
            {" "}
            <img src={linkedin} alt="My LinkedIn profile" class="icon" />
          </a>
          <a href="https://github.com/ppckv">
            <img src={github} alt="My Github profile" class="icon" />
          </a>
          <a href="https://www.instagram.com/premkumar_nv/">
      ...
      <div class="section-container">
        ...
        <div class="about-details-container">
          ...
          <div class="text-container">
            <p>
              "I am Prem Kumar N V, a highly motivated and creative engineer
              with a strong inclination towards learning and contributing
              innovative ideas. My primary goal is to apply my expertise to aid
              organizations in achieving their objectives effectively. Based in
              Chennai, Tamil Nadu, India, I am enthusiastic about tackling
              complex challenges and working collaboratively in
      ...
      <div class="experience-details-container">
        <div class="about-containers">
          <div class="details-container color-container">
            ...
            <div class="btn-container">
              <a href="https://github.com/ppckv/ITG">
                <button class="btn btn-color-2 project-btn">Github</button>
              </a>
              <a href="https://ppckv.github.io/ITG/">
          ...
          <div class="details-container color-container">
            ...
            <div class="btn-container">
              <a href="https://github.com/ppckv/Buddypro">
                {" "}
                <button class="btn btn-color-2 project-btn">Github</button>
              </a>
    ...
    <section id="contact">
      ...
      <div class="contact-info-upper-container">
        <div class="contact-info-container">
          ...
          />
          <p>
            <a href="mailto:premkumarbtech2002@gmail.com">
              premkumarbtech2002@gmail.com
            </a>
          </p>
        </div>
        <div class="contact-info-container">
          ...
          <p>
            <a href="https://www.linkedin.com/in/premkumar-btech/">LinkedIn</a>
          </p>
        </div>
      </div>
    </section>
...
function Footer() {
  return (
    <footer>
      ...
      <p>Copyright &#169; 2023 Prem. All Rights Reserved.</p>
    </footer>
  );
}
